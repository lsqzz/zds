  ...
  <div class="page-nav">
    <div class="nav_head">
      ...
      <div
        ...
        :key="index"
        @click="setDataId(item.platform_category_id)"
      >
      <span :class="item.platform_category_id ==dataId?'activeH':''">
      {{item.platform_category_name}}
      </span>
      </div>
    </div>
    <!-- 导航页主体内容 -->
    <div class="nav_comtent">
      <ul class="nav_coment_left">
        ...
        >
        <span :class="item.platform_category_id ==leftDataId?'activeL':''">
        {{item.platform_category_name}}
        </span>
        </li>
      </ul>
